...
const QuestionsPage = () => {
  ...
  const currentMembership = activeGroup?.memberships.find(
                ...
                <ul className="flex flex-col gap-2" aria-label="질문 목록">
                  {sortedQuestions.map((q, i) => (
                    <QuestionItem
                      ...
                      onEdit={() =>
                        setEditTarget({ id: q.id, question: q.question })
                      }
                      onDelete={() =>
            ...
            <Card className="border-amber-200 bg-amber-50">
              ...
              <CardContent>
                <p className="text-xs text-amber-700">
                  질문 추가, 수정, 삭제는 그룹 리더만 할 수 있어요. 멤버는 답변만 작성할 수
                  있어요.
                </p>
              </CardContent>
            </Card>
